...
import { Stethoscope, GraduationCap, Sparkles, Activity, Scale, Smile } from "lucide-react";
...
export default function HomePage() {
  ...
  const industries = [
    ...
    { id: 'aesthetics', icon: Sparkles },
    { id: 'physio', icon: Activity },
    { id: 'legal', icon: Scale },
      ...
      <section className="py-24 bg-zinc-950 relative">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 auto-rows-[300px]">
            ...
            <Link href="/signup" className="md:col-span-2 rounded-3xl border border-white/10 bg-zinc-900/50 p-8 relative overflow-hidden group hover:border-[#84c9ad]/50 transition-all flex flex-col justify-between cursor-pointer">
              ...
              <div className="relative z-10 mb-8">
                ...
                <p className="text-zinc-400 max-w-sm group-hover:text-zinc-300 transition-colors">{t('features.f1.desc')}</p>
              </div>
            ...
            {/* Tall Card (Reviews) */}
            <Link href="/signup" className="md:row-span-2 rounded-3xl border border-white/10 bg-zinc-900/50 p-8 relative overflow-hidden group hover:border-yellow-500/50 transition-all cursor-pointer">
              ...
              <p className="text-zinc-400 group-hover:text-zinc-300 transition-colors">{t('features.f3.desc')}</p>
               <div className="mt-8 space-y-3">
                  {[5,5,4].map((stars, i) => (
                    <div key={i} className="p-3 bg-zinc-950/50 rounded-lg border border-white/5 group-hover:border-yellow-500/20 transition-colors">
            ...
            {/* Small Card (Inbox) */}
            <Link href="/signup" className="rounded-3xl border border-white/10 bg-zinc-900/50 p-8 hover:bg-zinc-900 hover:border-indigo-500/50 transition-all cursor-pointer group">
               ...
               <p className="text-zinc-400 text-sm group-hover:text-zinc-300">{t('features.f2.desc')}</p>
            </Link>

            {/* Small Card (Campaigns) */}
            <Link href="/signup" className="rounded-3xl border border-white/10 bg-zinc-900/50 p-8 hover:bg-zinc-900 hover:border-[#84c9ad]/50 transition-all cursor-pointer group">
               ...
               <p className="text-zinc-400 text-sm group-hover:text-zinc-300">{t('features.f4.desc')}</p>
            </Link>

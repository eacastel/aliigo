"use strict";(()=>{function D(r){if(!Array.isArray(r))return;let o=[];for(let e of r){if(!e||typeof e!="object")continue;let t=e,s=t.type;if(s==="cta"){let n=typeof t.label=="string"?t.label:"",a=typeof t.url=="string"?t.url:"";n&&a&&o.push({type:"link",label:n,url:a});continue}if(s==="collect_lead"){let n=Array.isArray(t.fields)?t.fields.filter(i=>i==="name"||i==="email"||i==="phone"):[],a=typeof t.reason=="string"?t.reason:void 0;o.push({type:"lead_form",fields:n.length?n:["name","email"],reason:a});continue}}return o.length?o:void 0}var P={en:{pill:r=>r?`Ask ${r}`:"Chat",title:r=>r?`${r} Assistant`:"Assistant",welcome:"Ask a question and we\u2019ll help right away.",placeholder:"Type your question\u2026",send:"Send",errors:{sessionRefreshed:"Session refreshed. Please try again.",session:"Session error",network:"Network error",generic:"Something went wrong. Please try again."},lead:{title:"Share your details",name:"Name",email:"Email",phone:"Phone",submit:"Send details",sent:"Thanks! We\u2019ll be in touch.",message:"Here are my contact details.",hiddenMessage:"Lead submitted.",followUp:"Thanks \u2014 we\u2019ve received your information. We\u2019ll follow up shortly.",consent:"I agree to be contacted about my request.",consentNote:"Your information will only be used to follow up on this request."}},es:{pill:r=>r?`Pregunta a ${r}`:"Chat",title:r=>r?`Asistente de ${r}`:"Asistente",welcome:"Haz tu consulta y te ayudamos al momento.",placeholder:"Escribe tu consulta\u2026",send:"Enviar",errors:{sessionRefreshed:"Sesi\xF3n actualizada. Int\xE9ntalo de nuevo.",session:"Error de sesi\xF3n",network:"Error de red",generic:"Algo sali\xF3 mal. Int\xE9ntalo de nuevo."},lead:{title:"D\xE9janos tus datos",name:"Nombre",email:"Email",phone:"Tel\xE9fono",submit:"Enviar datos",sent:"\xA1Gracias! Te contactaremos.",message:"Aqu\xED tienes mis datos de contacto.",hiddenMessage:"Datos enviados.",followUp:"Gracias \u2014 hemos recibido tu informaci\xF3n. Te responderemos en breve.",consent:"Acepto que me contacten sobre mi solicitud.",consentNote:"Usaremos estos datos solo para dar seguimiento a tu solicitud."}}};function Z(r){return(r||"").toLowerCase().startsWith("es")}function Q(r,o){let e=[];if(Array.isArray(r))for(let t of r){let s=Z(String(t))?"es":"en";e.includes(s)||e.push(s)}return e.length||e.push(o),e.includes(o)||e.push(o),e}function N(r,o){let t=(r||"").trim().match(/#([0-9a-fA-F]{3}){1,2}/g)||[],s=t[0]||(o==null?void 0:o.bg)||"#111827",n=t[1]||(o==null?void 0:o.text)||"#ffffff";return{bg:s,text:n}}function ee(r){return Math.max(0,Math.min(1,r))}function ae(r){let o=(r||"").trim().replace("#","");if(o.length===3){let e=parseInt(o[0]+o[0],16),t=parseInt(o[1]+o[1],16),s=parseInt(o[2]+o[2],16);return{r:e,g:t,b:s}}if(o.length===6){let e=parseInt(o.slice(0,2),16),t=parseInt(o.slice(2,4),16),s=parseInt(o.slice(4,6),16);return{r:e,g:t,b:s}}return null}function le(r,o){let e=ae(r);return e?`rgba(${e.r}, ${e.g}, ${e.b}, ${ee(o)})`:null}function ce(r){return r.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}var K=class extends HTMLElement{constructor(){super(...arguments);this.STORAGE_TTL_MS=720*1e3;this.STORAGE_PREFIX="aliigo_widget_v1";this.pendingScroll=null;this.expiryTimer=null;this.lastActiveAtMs=null;this.lastRenderOpen=!1;this.pendingFocus=!1;this.sessionHydrated=!1;this.cachedTheme=null;this.cachedBrand="";this.onFocus=()=>this.checkExpiryNow();this.onVis=()=>{document.hidden||this.checkExpiryNow()};this.state={open:!1,busy:!1,conversationId:null,msgs:[],session:null,locale:"en",visitorSessionId:null}}static get observedAttributes(){return["variant","embed-key","api-base","locale","session-token","floating-mode","theme","brand","show-branding","start-open"]}ensureRoot(){this.shadowRoot?this.root=this.shadowRoot:this.root=this.attachShadow({mode:"open"})}connectedCallback(){if(this.ensureRoot(),this.state.visitorSessionId=this.getOrCreateVisitorSessionId(),this.loadPersisted(),this.getVariant()==="floating"&&this.state.msgs.length>0&&(this.state.open=!0,this.pendingScroll="bottom",this.pendingFocus=!0),this.getVariant()==="floating"&&this.getFloatingMode()==="fixed"&&!this.hasAttribute("data-no-teleport")){let e=document.body;this.parentElement!==e&&e.appendChild(this)}this.getVariant()==="floating"&&this.getStartOpen()&&(this.state.open=!0,this.pendingScroll="bottom",this.pendingFocus=!0),window.addEventListener("focus",this.onFocus),document.addEventListener("visibilitychange",this.onVis),this.scheduleExpiryTimer(),this.sessionHydrated=!1,this.render(),this.ensureSession().finally(()=>{this.sessionHydrated=!0,(this.state.session||!this.getEmbedKey())&&this.render()})}disconnectedCallback(){window.removeEventListener("focus",this.onFocus),document.removeEventListener("visibilitychange",this.onVis),this.clearExpiryTimer()}attributeChangedCallback(e,t,s){t!==s&&(this.ensureRoot(),this.render(),(e==="embed-key"||e==="api-base"||e==="session-token")&&(this.state.session=null,(e==="embed-key"||e==="session-token")&&(this.cachedTheme=null,this.cachedBrand="",this.sessionHydrated=!1),this.ensureSession().finally(()=>{this.sessionHydrated=!0,(this.state.session||!this.getEmbedKey())&&this.render()})))}clearExpiryTimer(){this.expiryTimer!=null&&(window.clearTimeout(this.expiryTimer),this.expiryTimer=null)}scheduleExpiryTimer(){if(this.clearExpiryTimer(),!this.lastActiveAtMs||this.state.msgs.length===0)return;let e=this.lastActiveAtMs+this.STORAGE_TTL_MS-Date.now();if(e<=0){this.expireConversation();return}this.expiryTimer=window.setTimeout(()=>{this.checkExpiryNow()},e+50)}checkExpiryNow(){if(!this.lastActiveAtMs||this.state.msgs.length===0)return;Date.now()-this.lastActiveAtMs>=this.STORAGE_TTL_MS?this.expireConversation():this.scheduleExpiryTimer()}expireConversation(){this.clearPersisted(),this.lastActiveAtMs=null,this.clearExpiryTimer(),this.state.msgs=[],this.state.conversationId=null,this.state.busy=!1,this.getVariant()==="floating"&&(this.state.open=!1),this.render()}applyPendingScroll(){let e=this.root.querySelector(".messages");if(!e||!this.pendingScroll)return;let t=this.pendingScroll;this.pendingScroll=null,t==="bottom"&&(e.scrollTop=e.scrollHeight),requestAnimationFrame(()=>{var n;let s=Math.max(0,e.scrollHeight-e.clientHeight);if(t==="bottom"){e.scrollTop=s;return}for(let a=this.state.msgs.length-1;a>=0;a--)if(((n=this.state.msgs[a])==null?void 0:n.role)==="assistant"){let i=this.root.querySelector(`#msg-${a}`);if(!i)return;let h=i.offsetTop-12;e.scrollTop=Math.max(0,Math.min(h,s));return}})}applyPendingFocus(){this.pendingFocus&&(this.pendingFocus=!1,requestAnimationFrame(()=>{let e=this.root.querySelector(".input");e==null||e.focus({preventScroll:!0})}))}getOrCreateVisitorSessionId(){let e="aliigo_visitor_session_v1";try{let t=localStorage.getItem(e);if(t&&t.length>=24)return t;let s=crypto.getRandomValues(new Uint8Array(16)),n=Array.from(s).map(a=>a.toString(16).padStart(2,"0")).join("");return localStorage.setItem(e,n),n}catch{return`${Date.now()}_${Math.random().toString(16).slice(2)}`}}storageKey(){let e=this.getEmbedKey(),t=this.getSessionTokenOverride(),s=(window.location.hostname||"").toLowerCase(),n=e||t||"no-key";return`${this.STORAGE_PREFIX}:${n}:${s}`}loadPersisted(){try{let e=localStorage.getItem(this.storageKey());if(!e)return;let t=JSON.parse(e);t.theme&&(this.cachedTheme=t.theme),typeof t.brand=="string"&&(this.cachedBrand=t.brand);let s=typeof t.lastActiveAt=="number"?t.lastActiveAt:typeof t.savedAt=="number"?t.savedAt:0;if(!s||Date.now()-s>this.STORAGE_TTL_MS){this.clearPersisted();return}typeof t.open=="boolean"&&(this.state.open=t.open),Array.isArray(t.msgs)&&(this.state.msgs=t.msgs),typeof t.conversationId=="string"&&(this.state.conversationId=t.conversationId),(t.locale==="en"||t.locale==="es")&&(this.state.locale=t.locale),this.state.msgs.length>0&&(this.lastActiveAtMs=s||Date.now())}catch{}}savePersisted(e=!0){try{let t=this.storageKey(),s=Date.now(),n=s,a;try{let c=localStorage.getItem(t);if(c){let l=JSON.parse(c);typeof l.savedAt=="number"&&(n=l.savedAt),typeof l.lastActiveAt=="number"&&(a=l.lastActiveAt)}}catch{}let i=e?s:a,h={savedAt:n,lastActiveAt:i,conversationId:this.state.conversationId,msgs:this.state.msgs,locale:this.state.locale,open:this.state.open,theme:this.cachedTheme,brand:this.cachedBrand};localStorage.setItem(t,JSON.stringify(h)),this.state.msgs.length>0?this.lastActiveAtMs=e?s:i!=null?i:this.lastActiveAtMs:this.lastActiveAtMs=null,this.scheduleExpiryTimer()}catch{}}clearPersisted(){try{localStorage.removeItem(this.storageKey())}catch{}}getBrandOverride(){return(this.getAttribute("brand")||"").trim()||null}getVariant(){let e=(this.getAttribute("variant")||"floating").toLowerCase();return e==="inline"||e==="hero"?e:"floating"}getEmbedKey(){return(this.getAttribute("embed-key")||"").trim()}getApiBase(){return(this.getAttribute("api-base")||"https://aliigo.com").trim().replace(/\/$/,"")}getLocaleOverride(){let e=(this.getAttribute("locale")||"").trim().toLowerCase();return e?e.startsWith("es")?"es":"en":null}detectWebsiteLocale(){var e;try{let t=(document.documentElement.lang||"").toLowerCase();if(t.startsWith("es"))return"es";if(t.startsWith("en"))return"en";let s=(((e=document.querySelector('meta[property="og:locale"],meta[name="og:locale"]'))==null?void 0:e.getAttribute("content"))||"").toLowerCase();if(s.startsWith("es"))return"es";if(s.startsWith("en"))return"en";let n=window.location.pathname.toLowerCase();if(/(^|\/)es(\/|$)/.test(n))return"es";if(/(^|\/)en(\/|$)/.test(n))return"en"}catch{}return null}getSessionTokenOverride(){return(this.getAttribute("session-token")||"").trim()||null}getThemeOverride(){let e=(this.getAttribute("theme")||"").trim();if(!e)return null;try{let t=JSON.parse(e),s={};return typeof t.headerBg=="string"&&(s.headerBg=t.headerBg),typeof t.bubbleUser=="string"&&(s.bubbleUser=t.bubbleUser),typeof t.bubbleBot=="string"&&(s.bubbleBot=t.bubbleBot),typeof t.sendBg=="string"&&(s.sendBg=t.sendBg),typeof t.panelBg=="string"&&(s.panelBg=t.panelBg),typeof t.panelOpacity=="number"&&(s.panelOpacity=t.panelOpacity),typeof t.headerLogoUrl=="string"&&(s.headerLogoUrl=t.headerLogoUrl),s}catch{return null}}getStartOpen(){return(this.getAttribute("start-open")||"").toLowerCase()==="true"}getShowBrandingOverride(){let e=(this.getAttribute("show-branding")||"").trim().toLowerCase();return e?e==="true"?!0:e==="false"?!1:null:null}getShowHeaderIconOverride(){let e=(this.getAttribute("show-header-icon")||"").trim().toLowerCase();return e?e==="true"?!0:e==="false"?!1:null:null}getHideHeader(){return(this.getAttribute("hide-header")||"").toLowerCase()==="true"}getFloatingMode(){return(this.getAttribute("floating-mode")||"").toLowerCase()==="absolute"?"absolute":"fixed"}async ensureSession(){var s,n;let e=this.getSessionTokenOverride(),t=this.getEmbedKey();if(!t&&!e)return null;if(this.state.session&&!e)return this.state.session;try{let a=this.getApiBase();if(e){let v=this.getLocaleOverride(),w=this.getThemeOverride(),_=this.getBrandOverride();return this.state.session={token:e,locale:v||this.state.locale,brand:(_||"").trim(),slug:"",theme:w,show_branding:(s=this.getShowBrandingOverride())!=null?s:!1,show_header_icon:(n=this.getShowHeaderIconOverride())!=null?n:!1,locale_auto:!1},this.cachedTheme=this.state.session.theme||null,this.cachedBrand=this.state.session.brand||"",this.state.locale=v||this.state.locale,this.savePersisted(!1),this.render(),this.state.session}let i=new URL(`${a}/api/embed/session`);i.searchParams.set("key",t),i.searchParams.set("host",window.location.hostname);let h=await fetch(i.toString(),{method:"GET"}),c=await h.json().catch(()=>({}));if(!h.ok||!c.token){this.state.session=null;let v=this.getLocaleOverride()||this.state.locale,w=P[v];return this.renderError(c.error||w.errors.session),null}let l=this.getLocaleOverride(),p=Z(c.locale||"en")?"es":"en",m=!!c.locale_auto,d=m?this.detectWebsiteLocale():null,u=Q(c.enabled_locales,p),I=l||d||p,A=u.includes(I)?I:p;return this.state.session={token:c.token,locale:A,brand:(c.brand||"").trim(),slug:(c.slug||"").trim(),theme:c.theme||null,show_branding:!!c.show_branding,show_header_icon:!!c.show_header_icon,locale_auto:m,enabled_locales:u},this.cachedTheme=this.state.session.theme||null,this.cachedBrand=this.state.session.brand||"",this.state.locale=A,this.savePersisted(!1),this.render(),this.state.session}catch{let a=this.getLocaleOverride()||this.state.locale,i=P[a];return this.renderError(i.errors.network),null}}async tryRefreshSessionToken(){var t;this.state.session=null;let e=await this.ensureSession();return(t=e==null?void 0:e.token)!=null?t:null}async refreshSessionIfStale(){var s;this.checkExpiryNow();let e=this.lastActiveAtMs?Date.now()-this.lastActiveAtMs:0,t=1500*1e3;(e>=t||!((s=this.state.session)!=null&&s.token))&&await this.tryRefreshSessionToken()}renderError(e){this.ensureRoot();let t=this.getLocaleOverride()||this.state.locale,s=P[t];this.root.innerHTML=`
    ...
    `}render(){var Y,X;this.ensureRoot();let e=this.getVariant();if(!!this.getEmbedKey()&&!this.getThemeOverride()&&!this.cachedTheme&&!((Y=this.state.session)!=null&&Y.theme)&&!this.sessionHydrated){let f=e==="floating"?`wrap floating ${this.getFloatingMode()}`:e==="hero"?"wrap hero":"wrap inline",g=e==="hero"?"panel hero":e==="inline"?"panel inline":"panel";this.root.innerHTML=`
        ...
        <style>${this.css()}</style>
        <div class="${V}">
          <button class="pill" style="background:${v.bg};color:${v.text};">${i.pill(d)}</button>
        </div>
      `,this.root.querySelectorAll(".action-btn[data-action='handoff']").forEach(E=>{E.addEventListener("click",()=>{this.send("I\u2019d like a human follow-up.")})});let g=this.root.querySelector(".pill");g==null||g.addEventListener("click",()=>{this.state.open=!0,this.pendingFocus=!0,this.savePersisted(!1),this.pendingScroll="bottom",this.render()});return}let ie=`${this.getApiBase()}/widget/v1/aliigo.svg`;this.root.innerHTML=`
      <style>${this.css()}</style>
      <div class="${V}">
      <div class="${se}" ${m}>
          ...
          <form class="form">
            ...
            <button class="send" type="submit" style="background:${v.bg};color:${v.text};" ${this.state.busy||!(s!=null&&s.token)?"disabled":""}>${i.send}</button>
          </form>
